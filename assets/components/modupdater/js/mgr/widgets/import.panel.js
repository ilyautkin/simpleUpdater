modUpdater.panel.Import = function (config) {
    config = config || {};
    if (!config.id) {
        config.id = 'modupdater-import-panel';
    }
    Ext.apply(config, {
		...
		items: [/*{
            ...
            height: 250,
            allowBlank: true,
            blankText: _('modupdater_nocsv')
        }, */{
            xtype: 'fileuploadfield',
            fieldLabel: _('modupdater_csvfile'),
            name: 'csv-file',
            ...
            xtype: 'button',
            text: _('modupdater_import_start'),
            fieldLabel: _('modupdater_import_start'),
            name: 'start-import',
            ...
            xtype: 'button',
            text: _('modupdater_import_file_select'),
            fieldLabel: _('modupdater_import_file_select'),
            name: 'csv-file-btn',
	...
	modUpdater.panel.Import.superclass.constructor.call(this, config);
};
Ext.extend(modUpdater.panel.Import, MODx.FormPanel, {
    _selectCSV: function() {
    ...
    _showFileName: function(e) {
        ...
        Ext.getCmp('modupdater-import-panel-log').body.dom.innerHTML = "";
        document.getElementById('modupdater-import-panel-log').style.display = "none";
...
Ext.reg('modupdater-import-panel', modUpdater.panel.Import);